    ...
    const renderCard = (card, index) => {
        return (
            <div className="p-4" key={index}>
                <Card className="p-3" style={{ width: '18rem', border: ".5rem solid #539987", boxShadow: "5px 5px 10px gray" }} >
                    <Card.Body>
                        <div className="row">
        ...
        <>
            <div className="row">
                <div className="p-4 d-flex justify-content-center">
                    <button type="button" className="btn" onClick={createGroupclick} style={{backgroundColor: "#b490ca", color: "white", fontWeight: "bold"}}>Create New Group</button>
                </div>
                <div className="row">
